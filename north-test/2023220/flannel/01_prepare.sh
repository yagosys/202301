...
ssh -i ~/.ssh/id_ed25519cfoslab 10.0.2.200 -o StrictHostKeyChecking=no ./02_createcniconfig.sh
ssh -i ~/.ssh/id_ed25519cfoslab 10.0.2.201 -o StrictHostKeyChecking=no ./02_createcniconfig.sh
